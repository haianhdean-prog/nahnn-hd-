...
local v15 = v14:CreateWindow({
    Title = "Nightowls Vip [ Premium ]",-- thay tên bạn muốn đặt
    SubTitle = "Crack by Hanhh",-- tên bạn
    TabWidth = 160,
    Theme = "Pink",--màu
    Acrylic = false,
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://www.tiktok.com/anhhanhdz");
    end
});
v16.Home:AddButton({
    Title = "Dicord",
    Description = "Click(Copy)",
    Callback = function()
        setclipboard("https://discord.gg/wQptSYQ2aG");
    end
});
v16.Home:AddButton({
    Title = "Remember:",
    Description = "Đây chỉ là bản crack banana hub do Hanhh .",
    Callback = function()
        setclipboard("https://www.tiktok.com/anhhanhdz");
    end
});
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://116877171316122") then --thay id ảnh vào
                    return v729;
                end
            end
        end
